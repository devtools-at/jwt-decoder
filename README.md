...
Use this tool online at **[DevTools.at](https://devtools.at/tools/jwt-decoder)** - Free, fast, and no registration required!
...
```bash
npm install @devtools-at/jwt-decoder
```

### Usage

```javascript
import { process, encode, decode } from '@devtools-at/jwt-decoder';
...
**[https://devtools.at/tools/jwt-decoder](https://devtools.at/tools/jwt-decoder)**
...
- [npm Package](https://www.npmjs.com/package/@devtools-at/jwt-decoder)
