...
<p align="center">
  <a href="https://devtools.at/tools/jwt-decoder"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Decode and inspect JSON Web Tokens</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/jwt-decoder">Try Online</a> •
...
**[Try JWT Decoder online at DevTools.at →](https://devtools.at/tools/jwt-decoder)**
...
Decode and inspect JSON Web Tokens. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { decode, verify, getExpiration } from '@devtools-at/jwt-decoder';
...
console.log(expiration); // Date object or null
```
